...
Descriptions must stand alone: action, requester, conversation IDs, links, needed context. No todo-to-todo references. Due reminders arrive in `<todo-reminder>`. If busy, no new run.
