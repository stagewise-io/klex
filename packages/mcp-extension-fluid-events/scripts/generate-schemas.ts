  ...
  const json = JSON.stringify(
    {
      ...
      $id: 'https://stagewise.io/mcp/extensions/fluid-events/schema.json',
      title: 'MCP Fluid Events Extension',
      description:
        'Protocol messages for the io.stagewise.fluid/events MCP extension.',
      $defs: definitions,
    },
    null,
    2,
